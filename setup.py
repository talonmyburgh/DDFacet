...
def define_scripts():
    ...
    SkyModel_scripts = [os.path.join(skymodel_pkg, script_name) for script_name in ['ClusterCat.py', 'dsm.py', 'dsreg.py', 'PEX.py', 
...
def requirements():
    ...
    requirements = ["nose >= 1.3.7; python_version >= '3'", 
                    ...
                    "matplotlib ==3.5.3; python_version >= '3'", 
